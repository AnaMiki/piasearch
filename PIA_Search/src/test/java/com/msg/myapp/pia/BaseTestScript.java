...
import static com.msg.myapp.pia.DriverThread.getDriverThread;
import static com.msg.myapp.pia.DriverThread.setUpThread;
...
public class BaseTestScript {
	...
	public void setUp(ITestContext context, Method method) throws Exception {
		...
		String url = context.getCurrentXmlTest().getParameter("urlCertification");
